...
public class Fonts {
    ...
    public static void create(Disposer disposer) {
        button = DefaultFont.create(new java.awt.Font("Gabriola", java.awt.Font.BOLD, 32), disposer);
        inputField = DefaultFont.create(new java.awt.Font("Gabriola", java.awt.Font.BOLD, 24), disposer);
    }
