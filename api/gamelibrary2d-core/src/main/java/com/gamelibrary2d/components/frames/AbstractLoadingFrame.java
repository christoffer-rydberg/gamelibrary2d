...
public abstract class AbstractLoadingFrame extends AbstractFrame implements LoadingFrame {
    ...
    protected FrameInitializationContext loadFrame(Frame frame) throws InitializationException {
        return frame.load();
    }
    ...
    public void load(Frame frame, Frame previousFrame, FrameDisposal previousFrameDisposal) throws InitializationException {
        ...
        if (frame.isLoaded()) {
            ...
            workerThread = new Thread(() -> {
                try {
                    FrameInitializationContext context = loadFrame(frame);
    ...
    protected static class LoadResult {
        ...
        public final FrameInitializationContext context;

        private LoadResult(Frame frame, FrameInitializationContext context, Frame previousFrame,
