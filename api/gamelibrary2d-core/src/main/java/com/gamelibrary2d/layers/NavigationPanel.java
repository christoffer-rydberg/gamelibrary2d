...
public class NavigationPanel extends AbstractFocusableObject implements Clearable, Renderable, Updatable, MouseAware, Parent<GameObject> {
    ...
    private MouseAware getContentAsMouseAware() {
    ...
    protected boolean onMouseClickEvent(int button, int mods, float projectedX, float projectedY) {
        MouseAware content = getContentAsMouseAware();
