...
public class Projection {
    ...
    /**
     * Projects the input coordinates from the "self" coordinate system of the {@link Transformable} target.
     */
    public static void projectFrom(Transformable target, float inputX, float inputY, Point output) {
        output.set(inputX, inputY);
     ...
     * Projects the input coordinates from the "self" coordinate system of the {@link Transformable} target.
     */
    public static void projectFrom(Transformable target, Point input, Point output) {
        projectFrom(target, input.getX(), input.getY(), output);
    }
}
